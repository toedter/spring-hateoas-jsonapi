...
| 2.2.1-SNAPSHOT | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/api/[API Documentation]
...
Gradle:
[source]
implementation 'com.toedter:spring-hateoas-jsonapi:2.2.0'
...
The latest published snapshot version is `2.2.1-SNAPSHOT`.
