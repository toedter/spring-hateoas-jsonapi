...
|===
| 0.8.0 | https://toedter.github.io/spring-hateoas-jsonapi/0.8.0/reference/index.html[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/0.8.0/api/index.html[API Documentation]
| 0.9.0-SNAPSHOT | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/reference/index.html[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/api/index.html[API Documentation]
|===
