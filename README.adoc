...
|===
| 1.2.0 | https://toedter.github.io/spring-hateoas-jsonapi/1.2.0/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/1.2.0/api/[API Documentation]
| 1.2.1-SNAPSHOT | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/api/[API Documentation]
|===
...
Gradle:
[source]
implementation 'com.toedter:spring-hateoas-jsonapi:1.2.0'

The latest published snapshot version is `1.2.1-SNAPSHOT`.
