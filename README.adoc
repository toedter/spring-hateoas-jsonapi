...
|===
| 0.14.0 | https://toedter.github.io/spring-hateoas-jsonapi/0.14.0/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/0.14.0/api/[API Documentation]
| 0.15.0-SNAPSHOT | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/api/[API Documentation]
|===
...
Gradle:
[source]
implementation 'com.toedter:spring-hateoas-jsonapi:0.14.0'

The latest published snapshot version is `0.15.0-SNAPSHOT`.
