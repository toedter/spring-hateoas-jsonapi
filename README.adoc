...
|===
| 1.5.1 | https://toedter.github.io/spring-hateoas-jsonapi/1.5.1/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/1.5.1/api/[API Documentation]
| 1.5.2-SNAPSHOT | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/api/[API Documentation]
|===
...
Gradle:
[source]
implementation 'com.toedter:spring-hateoas-jsonapi:1.5.1'

The latest published snapshot version is `1.5.2-SNAPSHOT`.
