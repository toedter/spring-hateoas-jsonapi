...
|===
| 1.0.2 | https://toedter.github.io/spring-hateoas-jsonapi/1.0.2/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/1.0.2/api/[API Documentation]
| 1.0.3-SNAPSHOT | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/reference/[Reference Documentation] | https://toedter.github.io/spring-hateoas-jsonapi/snapshot/api/[API Documentation]
|===
...
The latest published snapshot version is `1.0.3-SNAPSHOT`.
