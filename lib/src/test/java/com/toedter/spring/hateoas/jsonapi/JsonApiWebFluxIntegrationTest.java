...
class JsonApiWebFluxIntegrationTest extends JsonApiTestBase {
    ...
    void should_get_single_movie() throws Exception {
        EntityExchangeResult<String> result = this.testClient.get().uri("http://localhost/movies/1")
                .accept(JSON_API)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(JSON_API)
    ...
    void should_get_collection_of_movies() throws Exception {
        ...
        EntityExchangeResult<String> result = this.testClient.get().uri("http://localhost/movies")
                .accept(JSON_API)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(JSON_API)
    ...
    void should_create_new_movie() throws Exception {
        ...
        this.testClient.post().uri("http://localhost/movies").contentType(JSON_API)
                .bodyValue(input)
                .exchange()
                .expectStatus().isCreated()
                .expectHeader().valueEquals(HttpHeaders.LOCATION, "http://localhost/movies/3");

        EntityExchangeResult<String> result = this.testClient.get().uri("http://localhost/movies/3")
                .accept(JSON_API)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(JSON_API)
    ...
    void should_create_new_movie_with_relationships() throws Exception {
        ...
        this.testClient.post().uri("http://localhost/moviesWithDirectors").contentType(JSON_API)
                .bodyValue(input)
                .exchange()
                .expectStatus().isCreated()
                .expectHeader().valueEquals(HttpHeaders.LOCATION, "http://localhost/movies/3");

        EntityExchangeResult<String> result = this.testClient.get().uri("http://localhost/moviesWithDirectors/3")
                .accept(JSON_API)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(JSON_API)
    ...
    void should_patch_movie() throws Exception {
        ...
        this.testClient.patch().uri("http://localhost/movies/1").contentType(JSON_API)
                .bodyValue(input)
                .exchange()
                .expectStatus().isNoContent()
                .expectHeader().valueEquals(HttpHeaders.LOCATION, "http://localhost/movies/1");
    ...
    void should_return_error() throws Exception {
        ...
        EntityExchangeResult<String> result = this.testClient.get().uri("http://localhost/error")
                .accept(JSON_API)
                .exchange()
