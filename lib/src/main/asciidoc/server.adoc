...
=== Polymorphic Deserialization with Jackson Annotations ===

If you want that the JSON:API type is always the same (e.g. "movies"),
but you still want to support polymorphism,
