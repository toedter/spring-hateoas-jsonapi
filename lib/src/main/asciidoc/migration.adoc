...
Version 3.0.0 is the first release based on Spring Boot 4 and Jackson 3. The last version supporting Spring Boot 3 is 2.2.0.
...
Version 3.0.0 is a major version release due to the Spring Boot 4 and Jackson 3 migration.
...
`withObjectMapperCustomizer()`), your code will not compile with version 3.0.0. You must update your code to use the
