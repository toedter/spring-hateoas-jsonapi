...
:spring-hateoas-version: 1.5.1
:spring-hateoas-url: https://docs.spring.io/spring-hateoas/docs/1.5.x/reference/html/
...
* Snapshot repository: https://oss.sonatype.org/#nexus-search;quick~spring-hateoas-jsonapi[Sonatype OSS Repository]
